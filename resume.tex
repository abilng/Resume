...
\cventry{US-11599583-B2}{Improvements to distributed systems for avoiding deep pagination.}
{\newline \url{https://patents.google.com/patent/US11599583B2}}
{\hfill \textit{2020}}
{Systems and methods of the present disclosure provide a solution to the deep paginating over a result set in conventional distributed databases.}
